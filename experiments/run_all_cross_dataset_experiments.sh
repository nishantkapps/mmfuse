...
#   MODEL_FILE=path/to/model.pt ./experiments/run_all_cross_dataset_experiments.sh
#
# Prerequisites:
...
if [ -d "$VIDEOMME_DIR" ]; then
  ...
  echo "  Running evaluation (linear-probe for transfer; use no flag for finetuned checkpoint)..."
